...
@extend_schema_view(
    ...
    retrieve=extend_schema(
        responses=OpenApiResponse(response=UserSerializer, description='User data has been retrieved'),
        summary='Retrieve user data',
    ),
    update=extend_schema(
        responses=OpenApiResponse(response=UpdateUserSerializer, description='User data has been updated'),
        summary='Update user data PUT',
    ),
    partial_update=extend_schema(
        responses=OpenApiResponse(response=UpdateUserSerializer, description='User data has been updated'),
        summary='Update user data PATCH',
    ),
